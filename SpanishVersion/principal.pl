...
$window->set_title('Dissection :: Realizar imagen');	# Nombre de ventana: Herramientas forenses
$window->set_default_size(400, 200);

#Preparación de widgets
my $vbox = Gtk2::VBox->new(FALSE,5);
$label01 = Gtk2::Label->new("Introduzca su nombre:");
$label01->set_alignment(0.0, 0.0);
$entry01 = Gtk2::Entry->new();
$label02 = Gtk2::Label->new("Introduzca su DNI:");
$label02->set_alignment(0.0, 0.0);
$entry02 = Gtk2::Entry->new();
$label03 = Gtk2::Label->new("Introduzca comentario:");
$label03->set_alignment(0.0, 0.0);
$entry03 = Gtk2::Entry->new();
my $label1 = Gtk2::Label->new("Seleccione unidad a analizar:");
...
#Create Folder---->
my $op1 = 0;
my $check1 = Gtk2::CheckButton->new("Generar imagen comprimida");
...
my $label3 = Gtk2::Label->new("Seleccione que tipo de firmado aplicar:");
...
# Botones #
my $button1 = Gtk2::Button->new("Aceptar");
my $button2 = Gtk2::Button->new("Salir");
...
\usepackage{url} 
  \usepackage[pdftitle={Informe final}, 
...
';	
	...
	$text = '\item [Directorio salida]: ';
	print FICH "$text $direccionsalida\n";

	$text = '\item [Fecha inicio análisis]: ';
	...
	# Creamos la imagen
	print "Creando imagen dd, por favor espere...\n";
...
### Método con threads usando USR1
	...
	$fecha = `date`;
	$text = '\item [Fecha creación imagen]: ';
	print FICH "$text $fecha\n";
	$text = '
';
	print FICH "$text";
	...
	print "Realizado el firmado $firma.\n";
	...
	if ($op1 == 1){	
		print "Comprimiendo la imagen, por favor espere...\n";
		...
		chdir($dactual);
		exec("perl verificar.pl $direccionsalida $firma");
