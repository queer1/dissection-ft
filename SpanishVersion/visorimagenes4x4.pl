...
my($window,$boton_anterior,$boton_siguiente,$i,$j,$maxarray,$imagenvacia,
	...
	%evidencia,$fichevidencia,$fichvisto,$fichi,$clave,$valor,$status,$ev,
...
my $check10 = Gtk2::CheckButton->new("Marcar como prueba");
my $check11 = Gtk2::CheckButton->new("Marcar como prueba");
my $check12 = Gtk2::CheckButton->new("Marcar como prueba");
my $check13 = Gtk2::CheckButton->new("Marcar como prueba");
my $check14 = Gtk2::CheckButton->new("Marcar como prueba");
my $check15 = Gtk2::CheckButton->new("Marcar como prueba");
my $check16 = Gtk2::CheckButton->new("Marcar como prueba");
