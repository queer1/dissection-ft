...
if ( $#ARGV == 0 ) { # El ultimo indice es 0, por lo tanto hay un elemento
	...
	die "Error, se necesita un argumento con la direccion de salida\n";
}
...
$programa = Gtk2::GladeXML->new('visorimagenes.glade'); #Le estoy indicando la ruta (ubicación) donde se encuentra el XML generado por Glade, del cual Gtk2::GladeXML analizará y extraerá
...
$ventana_principal->set_title('Dissection :: Visor de Imagenes');
...
$boton_siguiente->set_label("_Siguiente");
$boton_anterior->set_label("_Anterior");
