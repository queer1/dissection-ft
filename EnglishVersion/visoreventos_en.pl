...
$window->set_title('Dissection :: Event Viewer');
...
# Boton de actualizar
my $labelficheros = Gtk2::Label->new("Choose log files:");
...
my $labelexpreg = Gtk2::Label->new("Regular expression:");
my $entryexpreg = Gtk2::Entry->new_with_max_length(20);
...
for $x (0 .. $#lines){
		...
		$menuitem1 = Gtk2::MenuItem->new("Absolutely true");			# Verde
		$menuitem2 = Gtk2::MenuItem->new("Absolutely false");			# Rojo	
		$menuitem3 = Gtk2::MenuItem->new("Maybe true");					# Azul
		$menuitem4 = Gtk2::MenuItem->new("Maybe false");				# Magenta '#FF00FF'
		$menuitem5 = Gtk2::MenuItem->new("Unknown"); 					# Negro
		#
